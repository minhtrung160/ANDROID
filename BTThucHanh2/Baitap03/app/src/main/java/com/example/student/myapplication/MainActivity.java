...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chuyen = (Button)findViewById(R.id.btn_chuyen);
        thoat = (Button)findViewById(R.id.btn_thoat);
        duonglich = (EditText)findViewById(R.id.edt_dl);
        amlich = (TextView)findViewById(R.id.txt_al);

        chuyen.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String can = "", chi = "";
                int namduong = Integer.parseInt(duonglich.getText()+"");
                switch(namduong%10){
